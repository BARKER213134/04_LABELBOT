...
1. **Переключите environment в Admin Panel**:
   - Откройте: https://shipengine-dashboard.preview.emergentagent.com/admin
...
curl https://shipengine-dashboard.preview.emergentagent.com/api/admin/api-config

# Симулировать webhook
API_URL="https://shipengine-dashboard.preview.emergentagent.com"
