...
1. **Переключите environment в Admin Panel**:
   - Откройте: https://shipbot-labels.preview.emergentagent.com/admin
...
curl https://shipbot-labels.preview.emergentagent.com/api/admin/api-config

# Симулировать webhook
API_URL="https://shipbot-labels.preview.emergentagent.com"
