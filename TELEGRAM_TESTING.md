...
1. **Переключите environment в Admin Panel**:
   - Откройте: https://labelgen-5.preview.emergentagent.com/admin
...
curl https://labelgen-5.preview.emergentagent.com/api/admin/api-config

# Симулировать webhook
API_URL="https://labelgen-5.preview.emergentagent.com"
