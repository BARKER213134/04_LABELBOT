...
1. **Переключите environment в Admin Panel**:
   - Откройте: https://telegram-shipper.preview.emergentagent.com/admin
...
curl https://telegram-shipper.preview.emergentagent.com/api/admin/api-config

# Симулировать webhook
API_URL="https://telegram-shipper.preview.emergentagent.com"
