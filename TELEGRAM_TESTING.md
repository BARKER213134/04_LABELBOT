...
1. **Переключите environment в Admin Panel**:
   - Откройте: https://shipping-dashboard-8.preview.emergentagent.com/admin
...
curl https://shipping-dashboard-8.preview.emergentagent.com/api/admin/api-config

# Симулировать webhook
API_URL="https://shipping-dashboard-8.preview.emergentagent.com"
