...
1. **Переключите environment в Admin Panel**:
   - Откройте: https://shipnow-bot.preview.emergentagent.com/admin
...
curl https://shipnow-bot.preview.emergentagent.com/api/admin/api-config

# Симулировать webhook
API_URL="https://shipnow-bot.preview.emergentagent.com"
