...
1. **Переключите environment в Admin Panel**:
   - Откройте: https://cargo-flow-22.preview.emergentagent.com/admin
...
curl https://cargo-flow-22.preview.emergentagent.com/api/admin/api-config

# Симулировать webhook
API_URL="https://cargo-flow-22.preview.emergentagent.com"
